...
```
docker build -t my-apache-app:1.0 .
```

**¿Cuántos pasos se han ejecutado?**

debido a la modificacion del dockerfile se ejecutaron 5 pasos.
...
```
docker run -p 80:80 -p 443:443 my-apache-app:1.0
```

### ¿Con que puerto host se está realizando el mapeo?

puerto 8080 para el host y el 80 para el contenedor

**¿Qué es una imagen huérfana?**

Una imagen huérfana es una imagen Docker que no está asociada a ningún contenedor en ejecución. Esto ocurre cuando las imágenes se generan pero no se utilizan o si un contenedor que las usa se elimina, dejándolas sin ningún uso.
